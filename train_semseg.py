...
classes = ['Shed','Concretehouse','Cementroad','Dirtroad','Slope','Scarp','Dam','Vegetablefield','Grassland','Dryland',
...
def parse_args():
    ...
    parser.add_argument('--gpu', type=str, default='7', help='GPU to use [default: GPU 0]')
...
def main(args):
    ...
    root = '/202221623116/Zhongshui/data/WCS3D_F'
    NUM_CLASSES = 15
        ...
        with torch.no_grad():
            ...
            for l in range(NUM_CLASSES):
                iou_per_class_str += 'class %s weight: %.3f, IoU: %.3f \n' % (
                    seg_label_to_cat[l] + ' ' * (16 - len(seg_label_to_cat[l])), labelweights[l - 1],
